...
function webRtcPlayer(parOptions) {
    ...
    this.forceMaxBundle = false; //Added this instead, by Burak
    ...
    this.useMic = false; //Added this instead, by Burak
    ...
    console.log(this.preferSFU ? 
        ...
        "The browser will signal for a P2P connection. Pass ?preferSFU in the url to signal for SFU usage.");*/ //Disabled by Burak
    this.preferSFU = false; //Added this instead, by Burak
    ...
    setupDataChannelCallbacks = function(datachannel) {
        try {
            ...
            datachannel.onclose = function (e) {
                console.log("Data channel closed", e); //Burak fix opened->closed
            }
...
//                    console.log(JSON.stringify(stat, undefined, 4));
    ...
    this.setVideoEnabled = function(enabled) {
         //Burak fix starts
        if(!self.video || !self.video.srcObject)
        {
            return;
        }
         //Burak fix ends
